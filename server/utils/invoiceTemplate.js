...
<head>
  <style>
    ...
    .header { background-color: #0066FF; padding: 40px; color: #ffffff; }
    .logo { font-size: 24px; font-weight: 900; letter-spacing: -1px; margin-bottom: 12px; text-transform: uppercase; color: #ffffff; }
